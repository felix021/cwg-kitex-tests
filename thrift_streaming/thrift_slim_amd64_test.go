...
func RunSlimThriftServer(handler echo.EchoService, opts ...server.Option) server.Server {
...
func TestSlimKitexServerMiddleware(t *testing.T) {
	...
	t.Run("pingpong", func(t *testing.T) {
		svr := RunSlimThriftServer(&SlimEchoServiceImpl{}, WithServerAddr(addr), svrCodecOpt,
